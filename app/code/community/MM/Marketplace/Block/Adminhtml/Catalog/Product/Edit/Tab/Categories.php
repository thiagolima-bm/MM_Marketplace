 ...
 */
class MM_Marketplace_Block_Adminhtml_Catalog_Product_Edit_Tab_Categories extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('mm/marketplace/catalog/product/edit/categories.phtml');
    }
