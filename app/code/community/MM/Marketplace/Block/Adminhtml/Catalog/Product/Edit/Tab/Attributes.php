 ...
 */
class MM_Marketplace_Block_Adminhtml_Catalog_Product_Edit_Tab_Attributes extends MM_Marketplace_Block_Adminhtml_Catalog_Form
{
	/**
        ...
        if ($group) {
            ...
            if ($tierPrice) {
                $tierPrice->setRenderer(
                    $this->getLayout()->createBlock('marketplace/adminhtml_catalog_product_edit_tab_price_tier')
                );
            }
