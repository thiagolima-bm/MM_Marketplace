 ...
 */
class MM_Marketplace_Block_Adminhtml_Catalog_Form_Renderer_Fieldset_Element
    extends Mage_Adminhtml_Block_Widget_Form_Renderer_Fieldset_Element
{
    ...
    {
        $this->setTemplate('mm/marketplace/catalog/form/renderer/fieldset/element.phtml');
    }
